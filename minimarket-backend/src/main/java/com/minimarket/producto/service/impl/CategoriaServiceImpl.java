...
public class CategoriaServiceImpl implements com.minimarket.producto.service.CategoriaService {
 ...
 @Transactional public CategoriaResponseDTO crear(CategoriaRequestDTO r){
 ...
 @Transactional public CategoriaResponseDTO actualizar(Long id,CategoriaRequestDTO r){
 ...
 @Transactional public void desactivar(Long id){find(id).setActivo(false);}
